            ...
            error: function(xhr, textStatus) {
              if (isActive) {
                if (optionError) {
				 ...
				 // $cluetipInner.load('http://dev3.ispg.in/mtp-dev/ajax/checkuser/get_classes_student_popup/63')
                }
              }
            },
 ...
 */
  ...
  $.fn.cluetip.defaults = {  // set up default options
    ...
    titleAttribute:   'name',  // the attribute to be used for fetching the clueTip's title
